...
import com.gomes.assistant.dto.Response;
...
public class OAuth2CallbackController {
	...
	@GetMapping("/callback")
	public ResponseEntity<Response> callback(@RequestParam("code") String code,
		...
		return ResponseEntity.ok(new Response("Token obtido com sucesso"));
	}
